...
$barang = query("SELECT * FROM barang WHERE kategori = 'aksesoris' ORDER BY id_barang DESC");
...
<head>
    ...
    <!-- mycss -->
    <link rel="stylesheet" href="assets/css/style-aksesoris.css">
    <title>Waroutfit &mdash; Aksesoris</title>
</head>
...
<body>
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item aktif" href="aksesoris.php">Aksesoris</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <!-- semua produk -->
    <section id="aksesoris">
        <div class="container-fluid mb-4">
            <div class="row">
                <div class="col p-3">
                    <h3 class="fw-normal">Aksesoris</h3>
                </div>
            </div>
